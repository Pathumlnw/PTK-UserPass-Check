    ...
    <div className="w-full text-left">
      <Listbox value={selected} onChange={onChange}>
        <div className="relative">
          ...
          <Listbox.Button className="relative w-full cursor-default rounded-lg bg-[rgba(255,255,255,0.25)] backdrop-blur-sm border border-[rgba(255,255,255,0.25)] py-3 px-4 text-left text-white shadow-md focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75 focus-visible:ring-offset-2 focus-visible:ring-offset-gray-800 sm:text-sm">
